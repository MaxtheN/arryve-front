          ...
          {rows.map((r, i) => (
            ...
            >
              ...
              <div className={`text-[13px] ${r.tone === 'dark' ? 'text-ivory-50/90' : 'text-forest-950/75'}`}>
                <span className={`md:hidden text-[10px] uppercase tracking-[0.2em] font-semibold block mb-1 ${r.tone === 'dark' ? 'text-ivory-50/60' : 'text-forest-950/50'}`}>Yo‘nalish</span>
                {r.focus}
              </div>
              <div className={`text-[13px] leading-[1.55] ${r.tone === 'dark' ? 'text-ivory-50' : 'text-forest-950/85'}`}>
                <span className={`md:hidden text-[10px] uppercase tracking-[0.2em] font-semibold block mb-1 ${r.tone === 'dark' ? 'text-ivory-50/60' : 'text-forest-950/50'}`}>Nega biz yutamiz</span>
                {r.why}
              </div>
            </div>
          ))}
